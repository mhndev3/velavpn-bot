...
SETTINGS_TREE = {
    ...
    "wallet": {
        "label": "💰 کیف پول",
        "items": {
            "wal_home":          ("صفحهٔ اصلی کیف‌پول — {balance}", "💰 کیف‌پول شما\n\nموجودی: {balance} تومان"),
            "wal_btn_balance":   ("دکمهٔ موجودی", "💰 موجودی"),
            "wal_btn_charge":    ("دکمهٔ شارژ", "➕ شارژ کیف‌پول"),
            "wal_btn_history":   ("دکمهٔ تاریخچه", "📊 تاریخچه"),
            "wal_balance":       ("نمایش موجودی — {amount}", "💰 موجودی: {amount} تومان"),
            "wal_hist_title":    ("عنوان تاریخچه", "📊 تاریخچه:\n\n"),
            "wal_hist_empty":    ("متن نبود تاریخچه", "تاریخچه‌ای ثبت نشده."),
            "wal_hist_item":     ("قالب هر تراکنش — {icon}{amount}{desc}", "{icon} {amount}T — {desc}\n"),
            "wal_charge_ask":    ("متن درخواست مبلغ شارژ", "➕ شارژ کیف‌پول\n\nمبلغ رو به تومان وارد کن (فقط عدد):\nمثال: 500000"),
            "wal_err_numeric":   ("خطای عدد نامعتبر", "❌ فقط عدد قبول میشه:"),
            "wal_err_min":       ("خطای حداقل مبلغ", "❌ حداقل ۱,۰۰۰ تومان:"),
            "wal_err_max":       ("خطای حداکثر مبلغ", "❌ حداکثر ۱۰۰,۰۰۰,۰۰۰ تومان:"),
            "wal_card_text":     ("متن کارت شارژ — {card}{amount}", "💳 اطلاعات کارت:\n<code>{card}</code>\n\nمبلغ: {amount} تومان\n\nلطفاً واریز کن و رسید (عکس یا متن) رو اینجا بفرست:"),
            "wal_receipt_no_text": ("متن رسید بدون کپشن", "رسید بدون متن"),
            "wal_charge_saved":  ("پیام ثبت درخواست شارژ — {amount}", "✅ درخواست شارژ ثبت شد\n\nمبلغ: {amount} تومان\nوضعیت: ⏳ در انتظار تایید ادمین"),
            "wal_approved_user": ("پیام تایید شارژ به کاربر — {amount}", "✅ شارژ کیف‌پول تایید شد!\n\nمبلغ: {amount} تومان\nاکنون می‌توانید خرید کنید."),
            "wal_rejected_user": ("پیام رد شارژ به کاربر — {amount}", "❌ شارژ کیف‌پول رد شد\n\nمبلغ: {amount} تومان\nدر صورت سوال با پشتیبانی تماس بگیرید."),
            "wal_btn_back":      ("دکمهٔ بازگشت", "⬅️ بازگشت"),
            "wal_btn_cancel":    ("دکمهٔ انصراف", "⬅️ انصراف"),
        },
    },
    "gbpricing": {
        "label": "📦 خرید حجمی",
        "items": {
            "gbp_intro":        ("صفحهٔ خرید حجمی — {price}", "📦 خرید بر اساس حجم\n\nقیمت هر گیگابایت: {price} تومان\n\nحجم مورد نظر رو انتخاب کن:"),
            "gbp_btn_step":     ("قالب دکمهٔ حجم — {gb}{price}", "📦 {gb} گیگ — {price} تومان"),
            "gbp_btn_custom":   ("دکمهٔ حجم دلخواه", "✍️ حجم دلخواه"),
            "gbp_btn_back":     ("دکمهٔ بازگشت", "⬅️ بازگشت"),
            "gbp_btn_confirm":  ("دکمهٔ تأیید خرید — {gb}{price}", "✅ تأیید خرید {gb} گیگ — {price} تومان"),
            "gbp_custom_ask":   ("متن حجم دلخواه — {price}", "✍️ حجم دلخواه\n\nقیمت هر گیگ: {price} تومان\n\nتعداد گیگابایت رو بفرست (عدد):"),
            "gbp_err_numeric":  ("خطای عدد نامعتبر", "فقط عدد قبول میشه"),
            "gbp_err_range":    ("خطای محدودهٔ حجم", "بین 1 تا 10000 گیگابایت وارد کن"),
            "gbp_confirm":      ("متن تأیید خرید — {gb}{price}", "📦 تأیید خرید\n\nحجم: {gb} گیگابایت\nقیمت: {price} تومان\n\nپرداخت از کیف‌پول انجام می‌شه."),
            "gbp_insufficient": ("خطای موجودی ناکافی — {need}{balance}{shortage}", "موجودی کافی نیست\n\nنیاز: {need}T\nموجودی: {balance}T\nکمبود: {shortage}T\n\nابتدا کیف‌پول رو شارژ کن"),
            "gbp_order_done":   ("پیام ثبت سفارش — {gb}{price}{order_id}", "✅ سفارش ثبت شد\n\nحجم: {gb} گیگابایت\nقیمت: {price} تومان\nسفارش: #{order_id}\n\n⏳ کانفیگ اختصاصی شما توسط ادمین ارسال می‌شه"),
        },
    },
    "subadmin": {
        "label": "👤 پنل ساب‌ادمین",
        "items": {
            "sa_welcome":        ("پیام خوش‌آمد ساب‌ادمین", "👤 پنل ساب‌ادمین\n\nخوش اومدی!\nاز این پنل می‌تونی آمار فروشت رو ببینی."),
            "sa_home_title":     ("عنوان پنل", "👤 پنل ساب‌ادمین"),
            "sa_no_access":      ("خطای عدم دسترسی", "دسترسی ندارید"),
            "sa_btn_total":      ("دکمهٔ آمار کلی", "📊 آمار کلی فروش"),
            "sa_btn_today":      ("دکمهٔ آمار امروز", "📅 آمار امروز"),
            "sa_btn_week":       ("دکمهٔ آمار هفتگی", "📈 آمار هفتگی"),
            "sa_btn_month":      ("دکمهٔ آمار ماهانه", "📆 آمار ماهانه"),
            "sa_btn_orders":     ("دکمهٔ سفارش‌های من", "🧾 سفارش‌های من"),
            "sa_btn_pricing":    ("دکمهٔ تعرفه من", "💰 تعرفه من"),
            "sa_btn_back":       ("دکمهٔ بازگشت", "⬅️ بازگشت"),
            "sa_total":          ("آمار کلی — {orders}{revenue}", "📊 آمار کلی فروش شما\n━━━━━━━━━━━━━━\n\n🧾 کل سفارش‌های تایید شده: {orders}\n💰 جمع کل فروش: {revenue} تومان\n"),
            "sa_commission_block": ("بلوک کمیسیون کل — {percent}{amount}", "📈 درصد کمیسیون شما: {percent}%\n💵 کمیسیون کل: {amount} تومان\n"),
            "sa_comm_line":      ("سطر کمیسیون دوره — {amount}", "💵 کمیسیون: {amount} تومان\n"),
            "sa_today":          ("آمار امروز — {date}{orders}{revenue}", "📅 آمار فروش امروز ({date})\n━━━━━━━━━━━━━━\n\n🧾 سفارش‌ها: {orders}\n💰 درآمد: {revenue} تومان\n"),
            "sa_week":           ("آمار هفتگی — {start}{end}{orders}{revenue}", "📈 آمار فروش ۷ روز اخیر\n({start} تا {end})\n━━━━━━━━━━━━━━\n\n🧾 سفارش‌ها: {orders}\n💰 درآمد: {revenue} تومان\n"),
            "sa_month":          ("آمار ماهانه — {start}{end}{orders}{revenue}", "📆 آمار فروش ۳۰ روز اخیر\n({start} تا {end})\n━━━━━━━━━━━━━━\n\n🧾 سفارش‌ها: {orders}\n💰 درآمد: {revenue} تومان\n"),
            "sa_orders_title":   ("عنوان سفارش‌ها", "🧾 سفارش‌های شما:\n\n"),
            "sa_orders_empty":   ("متن نبود سفارش", "هنوز سفارشی برای شما ثبت نشده."),
            "sa_order_item":     ("قالب هر سفارش — {icon}{order_id}{plan}{price}", "{icon} #{order_id} | {plan} | {price}T\n"),
            "sa_pricing_title":  ("عنوان تعرفه", "💰 تعرفه اختصاصی شما:\n\n"),
            "sa_pricing_empty":  ("متن نبود تعرفه", "💰 تعرفه اختصاصی شما\n\nهنوز تعرفه اختصاصی برای شما تنظیم نشده.\nبا هد ادمین تماس بگیرید."),
            "sa_pricing_item":   ("قالب هر تعرفه — {service}{plan}{price}{normal}{saved}", "📦 {service} — {plan}\n   قیمت شما: {price}T (قیمت عادی: {normal}T، تخفیف: {saved}T)\n\n"),
        },
    },
    "keyboards": {
